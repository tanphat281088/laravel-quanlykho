...
Route::get('/public/options', function () {
    return response()->json([
        'db'        => env('DB_DATABASE'),
        'pipelines' => DB::table('pipelines')->where('active',1)->orderBy('sort_order')->pluck('name'),
        'channels'  => DB::table('channels')->where('active',1)->orderBy('id')->pluck('name'),
...
Route::group([
    ...
    Route::prefix('khach-hang')->group(function () {
        ...
        // ==== BỔ SUNG 2 ROUTE MỚI CHO CRM ====
        Route::get('/lookup/phone', [\App\Modules\KhachHang\KhachHangController::class, 'lookupByPhone']);
        Route::post('/{id}/recalc', [\App\Modules\KhachHang\KhachHangController::class, 'recalc']);
    });
    ...
    Route::prefix('san-pham')->group(function () {
        ...
        Route::get('/search-popup', [\App\Modules\SanPham\SanPhamController::class, 'searchPopup']);
    ...
    Route::prefix('quan-ly-ban-hang')->group(function () {
        ...
        // NEW: thêm dòng vào đơn & áp dụng giá toàn đơn
        Route::post('/{id}/items/catalog', [\App\Modules\QuanLyBanHang\QuanLyBanHangController::class, 'addCatalogLine']);
        Route::post('/{id}/items/custom',  [\App\Modules\QuanLyBanHang\QuanLyBanHangController::class, 'addCustomLine']);
        Route::post('/{id}/apply-price-plan', [\App\Modules\QuanLyBanHang\QuanLyBanHangController::class, 'applyPricePlan']);
    });
